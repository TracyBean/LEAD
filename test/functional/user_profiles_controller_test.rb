...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { company: @user_profile.company, contact: @user_profile.contact, name: @user_profile.name, title: @user_profile.title }
    end
  ...
  test "should update user_profile" do
    put :update, id: @user_profile, user_profile: { company: @user_profile.company, contact: @user_profile.contact, name: @user_profile.name, title: @user_profile.title }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
